...
MenuLine menuItems[4] = { 
  { "Delivery",  1, DELIVERY_SPEED},
  { "Drafting",  1, DRAFTING_SPEED_PERCENTAGE},
...
void updateMenuValue() {
  ...
  switch(menuLinePos) {
    case 0:
      menuItems[0].value1 = incrementDeliverySpeed(ENCODER_CHANGE);
      break;
    case 1: 
      menuItems[1].value1 = incrementDraftingSpeedPercentage(ENCODER_CHANGE);
      break;
    case 2: 
      if (menuLineItemPos == 0) {
        menuItems[2].value1 = incrementSpindleSpeed(ENCODER_CHANGE);
      } else {
