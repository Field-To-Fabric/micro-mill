...
int incrementMOTOR1STEPS(int direction) {
  MOTOR_1_STEPS = MOTOR_1_STEPS + 50 * direction;
  return MOTOR_1_STEPS;
}

int incrementMOTOR2STEPS(int direction) {
  MOTOR_2_STEPS = MOTOR_2_STEPS + 50 * direction;
  return MOTOR_2_STEPS;
}

int incrementMOTOR3STEPS(int direction) {
  MOTOR_3_STEPS = MOTOR_3_STEPS + 50 * direction;
  return MOTOR_3_STEPS;
}

int incrementMOTOR4STEPS(int direction) {
  MOTOR_4_STEPS = MOTOR_4_STEPS + 50 * direction;
  return MOTOR_4_STEPS;
}

int incrementMOTOR5STEPS(int direction) {
  MOTOR_5_STEPS = MOTOR_5_STEPS + 50 * direction;
  return MOTOR_5_STEPS;
}
